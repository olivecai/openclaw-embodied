...
#     --robot.right_arm_config.cameras="{ wrist_right: {type: opencv, index_or_path: /dev/wrist_right, width: 640, height: 480, fps: 30}}"  \
#     --robot.left_arm_config.cameras="{ wrist_left: {type: opencv, index_or_path: /dev/wrist_left, width: 640, height: 480, fps: 30}}" \
#     --task=${TASK}  \
